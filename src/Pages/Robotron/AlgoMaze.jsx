...
const BrochureSection = () => {
  const brochureUrl = "https://drive.google.com/file/d/1GvbvWGgj2t3YaW4kiOjS6VgKG-U0kfsE"
  const downloadUrl = "https://drive.google.com/file/d/1GvbvWGgj2t3YaW4kiOjS6VgKG-U0kfsE"
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-col gap-3 w-full">
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-lg font-semibold shadow transition-all duration-200 ${modal.success ? 'bg-yellow-400 text-yellow-900 hover:bg-yellow-300' : 'bg-yellow-400 text-yellow-900 hover:bg-yellow-300'}`}
                >
                  Close
                </button>
              </div>
