...
const BrochureSection = () => {
  const brochureUrl = "https://drive.google.com/file/d/116Lsf5NJi8htGh2NqHqm-DTnIPAEa2eL/"
  const downloadUrl = "https://drive.google.com/file/d/116Lsf5NJi8htGh2NqHqm-DTnIPAEa2eL/"
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-col gap-3 w-full">
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-lg font-semibold shadow transition-all duration-200 ${modal.success ? 'bg-green-400 text-green-900 hover:bg-green-300' : 'bg-green-400 text-green-900 hover:bg-green-300'}`}
                >
                  Close
                </button>
              </div>
