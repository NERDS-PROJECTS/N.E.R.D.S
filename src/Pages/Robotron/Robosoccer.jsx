        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm px-2">
          ...
          >
            <div className="flex flex-col items-center gap-4">
              <div
                className={`rounded-full p-3 ${modal.success ? "bg-blue-400/20" : "bg-blue-400/20"
                  }`}
              >
                {modal.success ? (
                  <svg
              ...
              <div className="text-center">
                <h3
                  className={`text-xl sm:text-lg font-bold mb-2 ${modal.success ? "text-blue-200" : "text-blue-200"
                    }`}
                >
            ...
            >
              ...
              <div className="space-y-6 pt-8">
                ...
                >
                  ...
                  >
                    <div
                      className={`w-full bg-gradient-to-br from-black/60 to-blue-950/20 border-2 ${fileUrl
                          ? "border-green-500"
                    ...
                    >
                      <label className="flex flex-col items-center gap-4 cursor-pointer">
                        ...
                        >
                          <UploadIcon
                            className={`h-10 w-10 ${fileUrl ? "text-green-400" : "text-blue-400"
                              }`}
                          />
                        </div>
                        <div className="text-center">
