export const merchProducts = [
  {
    ...
    viewerBackground: null, // falls back to /background.jpg
    colors: ['Black'],
  ...
  },
  {
    ...
    year: 2026,
    status: 'available',
    description: 'The official N.E.R.D.S. T-Shirt for 2026.',
    model: 'tshirt/Gaymax GLB.glb',
    thumbnail: '/tshirt/niggerman3.jpg',
    viewerBackground: 'tshirt/merch-bg3.jpg',
    colors: ['Beige'],
    specs: ['240 GSM', 'Oversized', '200 GSM', 'Regular'],
    designer: 'Ahiron Sharma',
    featured: true,
  ...
  },
  {
    ...
    status: 'available',
    description: 'The official N.E.R.D.S. T-Shirt for 2026.',
    model: 'tshirt/Chudtron GLB.glb',
    thumbnail: 'tshirt/niggerman2.jpg',
    viewerBackground: 'tshirt/merch-bg2 .jpg',
    colors: ['Black'],
    specs: ['240 GSM', 'Oversized', '200 GSM', 'Regular'],
    designer: 'Ahiron Sharma',
    featured: true,
